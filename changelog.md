...
===== How to play =====
   ...
   * F10 declares an attack. Inform the specific player via chat in multiplayer. F10 again finishes the battle
   ...
   * For cards on the table a "Smart Action" is included by  double-clicking them. By order of priority 
     ...
     * On a Hero during an attack, it will make them participate in the attack
     * On a Hero outside an attack, or on a participating hero, it will Bow/Straighten the Hero
